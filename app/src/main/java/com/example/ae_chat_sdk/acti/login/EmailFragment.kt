...
class EmailFragment : Fragment(), View.OnClickListener, TextWatcher {
    ...
    override fun onCreateView(
        ...
        layoutEditEmail=v.findViewById<TextInputLayout>(R.id.input_email_layout)
    ...
    override fun afterTextChanged(s: Editable?) {
        ...
        fun String.isValidEmail() =
            !TextUtils.isEmpty(MainActivity.Email) && Patterns.EMAIL_ADDRESS.matcher(MainActivity.Email).matches()
